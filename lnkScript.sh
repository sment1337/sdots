...
printf '1\nY\n' | sudo pacman -S terminator i3-wm i3status xorg-xrandr picom polybar upower python-pip base-devel wget sddm nitrogen rofi conky
...
ln -s /home/sment/sdots/conky/ .config/conky
